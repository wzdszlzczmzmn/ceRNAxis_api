...
from analysis.utils.paired_cohort_task_utils import (
    ...
    build_paired_cohort_deg_pathway_data,
)
...
class PairedCohortDEGPathwayView(BaseWorkflowDEGPathwayView):
    """
    ...
    build_result_func = staticmethod(build_paired_cohort_deg_pathway_data)
    path_error_classes = (PairedCohortTaskPathError,)
    input_error_classes = (PairedCohortTaskInputError,)


class HybridReferenceDEGPathwayView(BaseWorkflowDEGPathwayView):
    """
    Return DEG pathway bubble plot data for HybridReferenceTask.
